    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/tara-zero/double-compresso/")
                ...
                scm {
                    connection.set("scm:git:git://github.com/tara-zero/double-compresso.git")
                    developerConnection.set("scm:git:ssh://github.com/tara-zero/double-compresso.git")
                    url.set("https://github.com/tara-zero/double-compresso/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/tara-zero/double-compresso/issues")
                }
            }
        }
    }
